(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('vue'), require('firebase')) :
	typeof define === 'function' && define.amd ? define(['exports', 'vue', 'firebase'], factory) :
	(factory((global.VueTransmit = {}),global.Vue,global.firebase));
}(this, (function (exports,Vue,firebase) { 'use strict';
	...
	var XHRDriver = /** @class */ (function () {
	    function XHRDriver(context, options) {
	        ...
	        var url = options.url, _a = options.method, method = _a === void 0 ? "post" : _a, _b = options.withCredentials, withCredentials = _b === void 0 ? false : _b, _c = options.timeout, timeout = _c === void 0 ? 0 : _c, _d = options.paramName, paramName = _d === void 0 ? "file" : _d, _e = options.multipleParamNameStyle, multipleParamNameStyle = _e === void 0 ? exports.ParamNameStyle.Empty : _e, _f = options.params, params = _f === void 0 ? Object.create(null) : _f, _g = options.headers, headers = _g === void 0 ? {
	            Accept: "application/json",
	            "Cache-Control": "no-cache",
	            "X-Requested-With": "XMLHttpRequest",
	        } : _g, _h = options.responseType, responseType = _h === void 0 ? "json" : _h, responseParseFunc = options.responseParseFunc, _j = options.errUploadError, errUploadError = _j === void 0 ? function (xhr) {
	            return "Error during upload: " + xhr.statusText + " [" + xhr.status + "]";
	        } : _j, _k = options.errUploadTimeout, errUploadTimeout = _k === void 0 ? function (_xhr) {
	            return "Error during upload: the server timed out.";
	        } : _k, _l = options.renameFile, renameFile = _l === void 0 ? function (name) { return name; } : _l;
	        if (!url) {
	            throw new TypeError(this.constructor.name + " requires a 'url' parameter. Supply a string or a function returning a string.");
	        }
	    ...
	    XHRDriver.prototype.uploadFiles = function (files) {
	        ...
	        return new Promise(function (resolve) {
	            ...
	            xhr.open(resolveStaticOrDynamic(_this.method, files), resolveStaticOrDynamic(_this.url, files), true);
	            ...
	            xhr.withCredentials = resolveStaticOrDynamic(_this.withCredentials, files);
	            ...
	            xhr.addEventListener("load", function () {
	                if (files[0].status === exports.UploadStatuses.Canceled ||
	            ...
	            for (var _e = 0, files_2 = files; _e < files_2.length; _e++) {
	                var file = files_2[_e];
	                _this.context.emit(exports.VTransmitEvents.Sending, file, xhr, formData);
	            }
	            if (_this.context.props.uploadMultiple) {
	                _this.context.emit(exports.VTransmitEvents.SendingMultiple, files, xhr, formData);
	            }
	            for (var i = 0, len = files.length; i < len; i++) {
	                formData.append(_this.getParamName(files[i], i), files[i].nativeFile, _this.renameFile(files[i].name));
	            }
	            xhr.send(formData);
	        });
	    };
	    XHRDriver.prototype.handleUploadProgress = function (files) {
	        ...
	        return function onProgressFn(e) {
	            ...
	            for (var _a = 0, files_4 = files; _a < files_4.length; _a++) {
	                ...
	                vm.$emit(exports.VTransmitEvents.UploadProgress, file, file.upload.progress, file.upload.bytesSent);
	            }
	        };
	    };
	...
	var VueTransmit = Vue.extend({render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c(_vm.tag,{tag:"component"},[(_vm.filesSlotFirst)?_vm._t("files",null,null,_vm.fileSlotBindings):_vm._e(),_vm._v(" "),_c('div',_vm._g(_vm._b({staticClass:"v-transmit__upload-area",class:[_vm.isDraggingClass, _vm.uploadAreaClasses],attrs:{"draggable":!_vm.disableDraggable},on:{"click":_vm.handleClickUploaderAction,"dragstart":_vm.handleDragStart,"dragend":_vm.handleDragEnd,"dragenter":function($event){$event.preventDefault();$event.stopPropagation();return _vm.handleDragEnter($event)},"dragover":function($event){$event.preventDefault();$event.stopPropagation();return _vm.handleDragOver($event)},"dragleave":_vm.handleDragLeave,"drop":function($event){$event.preventDefault();$event.stopPropagation();return _vm.handleDrop($event)}}},'div',_vm.uploadAreaAttrs,false),_vm.uploadAreaListeners),[_vm._t("default")],2),_vm._v(" "),(!_vm.filesSlotFirst)?_vm._t("files",null,null,_vm.fileSlotBindings):_vm._e(),_vm._v(" "),_c('form',{ref:"uploadForm",style:(_vm.formStyles)},[_c('input',{ref:"hiddenFileInput",class:[_vm.maxFilesReachedClass],attrs:{"type":"file","multiple":_vm.multiple,"accept":_vm.filesToAccept,"capture":_vm.capture},on:{"change":_vm.onFileInputChange}})])],2)},staticRenderFns: [],
	    name: "VueTransmit",
	    props: {
	        tag: {
	            type: String,
	        ...
	        errMaxFileSizeExceeded: {
	            ...
	            "default": function (fileSize, maxFileSize, units) {
	                return ("The file is too big (" + round(fileSize, 1) + units + ")." +
	    ...
	    mounted: function () {
	        var _this = this;
	        this.$on(exports.VTransmitEvents.UploadProgress, this.updateTotalUploadProgress);
	        this.$on(exports.VTransmitEvents.RemovedFile, this.updateTotalUploadProgress);
	        ...
	        this.$on(exports.VTransmitEvents.Complete, function (file) {
	            if (_this.addedFiles.length === 0 &&
	                ...
	                Promise.resolve().then(function () {
	                    return _this.$emit(exports.VTransmitEvents.QueueComplete, file);
	                });
	            }
	        });
	    ...
	    computed: {
	        ...
	        activeFiles: function () {
	            return this.getFilesWithStatus(exports.UploadStatuses.Uploading, exports.UploadStatuses.Queued);
	        },
	    ...
	    methods: {
	        ...
	        onFileInputChange: function () {
	            ...
	            this.$emit(exports.VTransmitEvents.AddedFiles, Array.from(inputEl.files).map(this.addFile));
	        ...
	        removeFile: function (file) {
	            ...
	            if (idxToRm > -1) {
	                this.$emit(exports.VTransmitEvents.RemovedFile, this.files.splice(idxToRm, 1)[0]);
	        ...
	        removeAllFiles: function (cancelInProgressUploads) {
	            ...
	            this.files
	                .filter(function (f) {
	                return f.status !== exports.UploadStatuses.Uploading ||
	        ...
	        enqueueFile: function (file) {
	            if (file.status !== exports.UploadStatuses.Added || file.accepted !== true) {
	        ...
	        createThumbnail: function (file, callback) {
	            ...
	            reader.addEventListener("load", function () {
	                if (file.type === "image/svg+xml") {
	                    ...
	                    _this.$emit(exports.VTransmitEvents.Thumbnail, file, reader.result);
	                    callback();
	                }
	        ...
	        createThumbnailFromUrl: function (file, imageUrl, callback) {
	            ...
	            imgEl.addEventListener("load", function () {
	                ...
	                _this.$emit(exports.VTransmitEvents.Thumbnail, file, thumbnail);
	                if (callback) {
	                    return callback();
	                }
	            }, false);
	        ...
	        processQueue: function () {
	            ...
	            if (len_uploading >= this.maxConcurrentUploads ||
	                this.queuedFiles.length === 0) {
	                return;
	            }
	            if (this.uploadMultiple) {
	                return this.processFiles(this.queuedFiles.slice(0, this.maxConcurrentUploads - len_uploading));
	            }
	            var i = len_uploading;
	            var file;
	        ...
	        cancelUpload: function (file) {
	            ...
	            if (file.status === exports.UploadStatuses.Added ||
	                file.status === exports.UploadStatuses.Queued) {
	            ...
	            if (file.status === exports.UploadStatuses.Uploading) {
	                ...
	                if (this.uploadMultiple) {
	                    this.$emit(exports.VTransmitEvents.CanceledMultiple, canceledFiles);
	                }
	            }
	            if (this.autoProcessQueue) {
	                this.processQueue();
	            ...
	            this.transport.uploadFiles(files).then(function (result) {
	                ...
	                switch (result.err.type) {
	                    case exports.ErrType.Any:
	                        _this.errorProcessing(files, result.err.message, result.err.data);
	                        break;
	                    case exports.ErrType.Timeout:
	                        _this.handleTimeout(files, result.err.message, result.err.data);
	                        break;
	                    default:
	        ...
	        handleTimeout: function (files, message, data) {
	            ...
	            this.$emit(exports.VTransmitEvents.TimeoutMultiple, files, message, data);
	            if (this.autoProcessQueue) {
	                this.processQueue();
	            }
	        },
	        ...
	        uploadFinished: function (files, response) {
	            ...
	            for (var _a = 0, files_3 = files; _a < files_3.length; _a++) {
	                ...
	                file.endProgress();
	                this.$emit.apply(this, [exports.VTransmitEvents.Success, file, response].concat(args));
	                this.$emit(exports.VTransmitEvents.Complete, file);
	            }
	            if (this.uploadMultiple) {
	                this.$emit.apply(this, [exports.VTransmitEvents.SuccessMultiple,
	                    files,
	                    response].concat(args));
	        ...
	        errorProcessing: function (files, message, data) {
	            ...
	            if (this.uploadMultiple) {
	                this.$emit(exports.VTransmitEvents.ErrorMultiple, files, message, data);
	                this.$emit(exports.VTransmitEvents.CompleteMultiple, files);
	            }
	            if (this.autoProcessQueue) {
	            ...
	            for (var _i = 0, acceptedFileTypes_1 = acceptedFileTypes; _i < acceptedFileTypes_1.length; _i++) {
	                ...
	                switch (true) {
	                    ...
	                    case valid_type.charAt(0) == ".":
	                        ...
	                        if (file.name
	                            .toLowerCase()
	                            .indexOf(valid_type.toLowerCase(), file.name.length - valid_type.length) !== -1) {
	                            return true;
	                        }
	                        break;
	                    // Handle globs ("image/*")
	        ...
	        handleDrop: function (e) {
	            ...
	            this.$emit(exports.VTransmitEvents.AddedFiles, (files = Array.from(e.dataTransfer.files)));
	    ...
	    FirebaseDriver.prototype.uploadFiles = function (files) {
	        ...
	        var _loop_1 = function (i, len) {
	            ...
	            tasks.push(new Promise(function (resolve) {
	                ...
	                var metadata = _this.options.metadata && _this.options.metadata(file);
	                var task = ref.put(files[i].nativeFile, metadata);
	                _this.cancelTokens[file.id] = function () { return task.cancel(); };
	                task.on(firebase.storage.TaskEvent.STATE_CHANGED, {
	                    ...
	                    next: function (snapshot) {
	                        _this.context.emit(exports.VTransmitEvents.UploadProgress, file, snapshot.bytesTransferred / snapshot.totalBytes * 100, snapshot.bytesTransferred);
	                    },
	                    error: console.error,
	                });
	            }));
	        ...
	        return Promise.all(tasks).then(function () { return ({ ok: true, data: {} }); });
	    };
	...
	var AxiosDriver = /** @class */ (function () {
	    function AxiosDriver(context, options) {
	        this.uploadGroups = Object.create(null);
	        var url = options.url, _a = options.method, method = _a === void 0 ? "post" : _a, _b = options.withCredentials, withCredentials = _b === void 0 ? false : _b, _c = options.timeout, timeout = _c === void 0 ? 0 : _c, _d = options.paramName, paramName = _d === void 0 ? "file" : _d, _e = options.multipleParamNameStyle, multipleParamNameStyle = _e === void 0 ? ParamNameStyle.Empty : _e, _f = options.params, params = _f === void 0 ? Object.create(null) : _f, _g = options.headers, headers = _g === void 0 ? {
	            Accept: "application/json",
	            "Cache-Control": "no-cache",
	            "X-Requested-With": "XMLHttpRequest",
	        } : _g, _h = options.responseType, responseType = _h === void 0 ? "json" : _h, responseParseFunc = options.responseParseFunc, _j = options.errUploadError, errUploadError = _j === void 0 ? function (xhr) {
	            ...
	            return "Error during upload: the server timed out.";
	        } : _k, _l = options.renameFile, renameFile = _l === void 0 ? function (name) { return name; } : _l, http = options.http;
	        if (!url) {
	            throw new TypeError(this.constructor.name + " requires a 'url' parameter. Supply a string or a function returning a string.");
	        }
	        this.context = context;
