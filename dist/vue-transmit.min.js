	...
	var f,
			...
			return (
				(t.prototype.uploadFiles = function(t) {
					...
					return new Promise(function(r) {
						...
						s.open(m(i.method, t), m(i.url, t), !0),
							(s.timeout = m(i.timeout, t)),
							(s.withCredentials = m(i.withCredentials, t)),
							(s.responseType = m(i.responseType, t)),
						...
						for (
							var f = new FormData(), v = 0, F = Object.keys(o);
							v < F.length;
							v++
						) {
							var y = F[v];
						...
						for (var T = 0, E = t; T < E.length; T++) {
							var b = E[T];
							i.context.emit(e.VTransmitEvents.Sending, b, s, f);
						}
						i.context.props.uploadMultiple &&
							i.context.emit(e.VTransmitEvents.SendingMultiple, t, s, f);
		...
		F = t.extend({
			...
			props: {
				...
				driver: { type: Function, default: v },
			},
			mounted: function() {
				var t = this;
				this.$on(
			...
			computed: {
				...
				transport: function() {
					var e = this.driver;
					try {
						return new e(new c(this), this.driverOptions);
					} catch (e) {
						throw (console.error(
		...
		T = (function() {
			function t(e, t) {
				...
				var i = t.url,
					...
					h = void 0 === p ? f.Empty : p,
					c = t.params,
					m = void 0 === c ? Object.create(null) : c,
					g = t.headers,
					v =
						void 0 === g
							? {
			...
			return (
				(t.prototype.uploadFiles = function(t) {
					...
					return new Promise(function(s) {
						...
						r.uploadGroups[n] = { id: n, xhr: a, files: t };
						for (var l = 0, u = t; l < u.length; l++) {
							((g = u[l]).driverData.groupID = n), g.startProgress();
						}
						for (
							var d = new FormData(), p = 0, h = Object.keys(o);
							p < h.length;
							p++
						) {
							var c = h[p];
						...
						for (var m = 0, f = t; m < f.length; m++) {
							var g = f[m];
							r.context.emit(e.VTransmitEvents.Sending, g, a, d);
						}
						r.context.props.uploadMultiple &&
							r.context.emit(e.VTransmitEvents.SendingMultiple, t, a, d);
						for (var v = 0, F = t.length; v < F; v++)
							d.append(
								r.getParamName(t[v], v),
								t[v].nativeFile,
								r.renameFile(t[v].name)
							);
						r.http({
							url: r.url,
							body: d,
