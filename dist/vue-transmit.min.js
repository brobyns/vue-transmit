!(function(e, t) {
	...
	((r = e.UploadStatuses || (e.UploadStatuses = {})).None = ""),
		(r.Added = "added"),
		(r.Queued = "queued"),
		(r.Accepted = "queued"),
		...
		(r.Timeout = "timeout"),
		(r.Success = "success"),
		((s = e.ErrType || (e.ErrType = {}))[(s.Any = 0)] = "Any"),
		(s[(s.Timeout = 1)] = "Timeout"),
		((a = e.VTransmitEvents || (e.VTransmitEvents = {})).Initialize =
			"initialize"),
		(a.AddedFile = "added-file"),
		(a.AddedFiles = "added-files"),
		(a.RemovedFile = "removed-file"),
		(a.AcceptedFile = "accepted-file"),
		(a.RejectedFile = "rejected-file"),
		(a.AcceptComplete = "accept-complete"),
		(a.Thumbnail = "thumbnail"),
		(a.Processing = "processing"),
		(a.ProcessingMultiple = "processing-multiple"),
		(a.Canceled = "canceled"),
		(a.CanceledMultiple = "canceled-multiple"),
		(a.Sending = "sending"),
		(a.SendingMultiple = "sending-multiple"),
		(a.Timeout = "timeout"),
		(a.TimeoutMultiple = "timeout-multiple"),
		(a.UploadProgress = "upload-progress"),
		(a.TotalUploadProgress = "total-upload-progress"),
		(a.Success = "success"),
		(a.SuccessMultiple = "success-multiple"),
		(a.QueueComplete = "queue-complete"),
		(a.Complete = "complete"),
		(a.CompleteMultiple = "complete-multiple"),
		(a.Error = "error"),
		(a.ErrorMultiple = "error-multiple"),
		(a.MaxFilesReached = "max-files-reached"),
		(a.MaxFilesExceeded = "max-files-exceeded"),
		(a.Reset = "reset"),
		(a.DragOver = "drag-over"),
		(a.DragEnter = "drag-enter"),
		(a.DragLeave = "drag-leave"),
		(a.DragEnd = "drag-end"),
		(a.Drop = "drop"),
		(a.Paste = "paste");
	var h,
	...
	var f = 0,
		g = (function() {
			...
			return (
				(t.prototype.uploadFiles = function(t) {
					...
					return new Promise(function(s) {
						...
						var a = new XMLHttpRequest(),
							n = r.handleUploadProgress(t),
							o = f++,
							l = (function(e, t) {
								return i(e) ? e(t) : e;
							})(r.params, t);
						r.uploadGroups[o] = { id: o, xhr: a, files: t };
						for (var u = 0, d = t; u < d.length; u++) {
							((F = d[u]).driverData.groupID = o), F.startProgress();
						}
						for (
							var p = new FormData(), h = 0, c = Object.keys(l);
							h < c.length;
							h++
						) {
							var m = c[h];
						...
						for (var g = 0, v = t; g < v.length; g++) {
							var F = v[g];
							r.context.emit(e.VTransmitEvents.Sending, F, a, p);
						}
						r.context.props.uploadMultiple &&
							r.context.emit(e.VTransmitEvents.SendingMultiple, t, a, p);
						for (var y = 0, T = t.length; y < T; y++)
							p.append(
								r.getParamName(t[y], y),
								t[y].nativeFile,
								r.renameFile(t[y])
							);
						r.http({
				...
				(t.prototype.getParamName = function(e, t) {
					var r;
					if (
						((r = i(this.paramName) ? this.paramName(e) : this.paramName),
		...
		v = t.extend({
			...
			props: {
				...
				uploadAreaAttrs: { type: Object, default: l },
				uploadAreaListeners: { type: Object, default: l },
				...
				errMaxFileSizeExceeded: {
					...
					default: function(e, t, i) {
						return {
							...
							data: { fileSize: o(e, 1), maxFileSize: o(t, 1) },
						};
					},
				},
				errInvalidFileType: {
				...
				driverOptions: { type: Object, default: l },
				driver: { type: Function, default: g },
			},
			mounted: function() {
				var t = this;
				this.$on(
					...
					this.processingThumbnail ||
						...
						(e = this.thumbnailQueue.shift()) &&
							this.createThumbnail(
								...
								function() {
									(t.processingThumbnail = !1),
										t.processThumbnailQueue();
								}
							));
				},
				createThumbnail: function(t, i, r, s) {
					var a = this;
					void 0 === s && (s = u);
					...
					n.addEventListener(
						...
						function() {
							"image/svg+xml" === t.type &&
								((t.dataUrl = n.result),
								a.$emit(e.VTransmitEvents.Thumbnail, t, n.result),
								s()),
								a.createThumbnailFromUrl(t, n.result, i, r, s);
						},
						!1
					),
						n.readAsDataURL(t.nativeFile);
				},
				createThumbnailFromUrl: function(t, i, r, s, a) {
					var n = this,
					...
					o.addEventListener(
						...
						function() {
							...
							var l = n.resize(t, { width: r, height: s }),
								u = document.createElement("canvas");
							if ((i = u.getContext("2d"))) {
								(u.width = l.dWidth),
									(u.height = l.dHeight),
									i.drawImage(
										o,
								...
								(t.dataUrl = d),
									n.$emit(e.VTransmitEvents.Thumbnail, t, d),
									a &&
										u.toBlob(function(e) {
											return a(e);
										});
						...
						a && o.addEventListener("error", a, !1),
						(o.src = i);
				},
	...
	var y = 0,
		T = (function() {
			function t(t, i) {
				...
				var r = i.url,
					...
					d = i.paramName,
					p = void 0 === d ? "file" : d,
					h = i.multipleParamNameStyle,
					c = void 0 === h ? e.ParamNameStyle.Empty : h,
					m = i.params,
					f = void 0 === m ? Object.create(null) : m,
					g = i.headers,
					v =
			...
			return (
				(t.prototype.uploadFiles = function(t) {
					...
					return new Promise(function(r) {
						...
						for (var p = 0, h = Object.keys(l); p < h.length; p++) {
							var c = h[p];
							l[c] && s.setRequestHeader(c, l[c]);
						}
						for (
							var m = new FormData(), f = 0, g = Object.keys(o);
							f < g.length;
							f++
						) {
							var v = g[f];
				...
				(t.prototype.getParamName = function(t, r) {
					var s;
					if (
						((s = i(this.paramName) ? this.paramName(t) : this.paramName),
						!this.context.props.uploadMultiple)
					)
						return s;
					switch (this.multipleParamNameStyle) {
		...
		E = {
			install: function(e) {
				e.component("VueTransmit", v);
			},
			name: "vue-transmit",
		};
	(e.VueTransmit = v),
		(e.VueTransmitPlugin = E),
		(e.AxiosDriver = g),
		(e.XHRDriver = T),
