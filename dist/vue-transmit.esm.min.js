...
var ParamNameStyle$1,
			...
			(e.prototype.uploadFiles = function(e) {
				...
				return new Promise(function(i) {
					...
					for (var o = 0, l = e; o < l.length; o++) {
						((f = l[o]).driverData.groupID = a), f.startProgress();
					}
					for (
						var u = new FormData(), d = 0, p = Object.keys(n);
						d < p.length;
						d++
					) {
						var c = p[d];
					...
					for (var h = 0, m = e; h < m.length; h++) {
						var f = m[h];
						t.context.emit(VTransmitEvents.Sending, f, r, u);
					}
					t.context.props.uploadMultiple &&
						t.context.emit(VTransmitEvents.SendingMultiple, e, r, u);
					for (var g = 0, v = e.length; g < v; g++)
						u.append(
							t.getParamName(e[g], g),
							e[g].nativeFile,
							t.renameFile(e[g])
						);
					t.http({
	...
	VueTransmit = Vue.extend({
		...
		props: {
			...
			errMaxFileSizeExceeded: {
				...
				default: function(e, t, i) {
					return {
						...
						data: { fileSize: round(e, 1), maxFileSize: round(t, 1) },
					};
				},
			},
			errInvalidFileType: {
			...
			driver: { type: Function, default: AxiosDriver },
		},
		mounted: function() {
			var e = this;
			this.$on(
		...
		methods: {
			...
			createThumbnail: function(e, t, i, r) {
				var s = this;
				void 0 === r && (r = noop);
				...
				a.addEventListener(
					...
					function() {
						"image/svg+xml" === e.type &&
							((e.dataUrl = a.result),
							s.$emit(VTransmitEvents.Thumbnail, e, a.result),
							r()),
							s.createThumbnailFromUrl(e, a.result, t, i, r);
					},
					!1
				),
					a.readAsDataURL(e.nativeFile);
			},
			createThumbnailFromUrl: function(e, t, i, r, s) {
				var a = this,
				...
				n.addEventListener(
					...
					function() {
						...
						var o = a.resize(e, { width: i, height: r }),
							l = document.createElement("canvas");
						if ((t = l.getContext("2d"))) {
							(l.width = o.dWidth),
								(l.height = o.dHeight),
								t.drawImage(
									n,
							...
							var u = l.toDataURL("image/png");
							(e.dataUrl = u),
								a.$emit(VTransmitEvents.Thumbnail, e, u),
								s &&
									l.toBlob(function(e) {
										return s(e);
									});
					...
					s && n.addEventListener("error", s, !1),
					(n.src = t);
			},
			...
			(e.prototype.uploadFiles = function(e) {
				...
				return new Promise(function(i) {
					...
					var r = new XMLHttpRequest(),
						s = t.handleUploadProgress(e),
						a = group_id$1++,
						n = resolveStaticOrDynamic$1(t.params, e),
						o = resolveStaticOrDynamic$1(t.headers, e);
					t.uploadGroups[a] = { id: a, xhr: r, files: e };
					for (var l = 0, u = e; l < u.length; l++) {
						((F = u[l]).driverData.groupID = a), F.startProgress();
					}
					r.open(
						resolveStaticOrDynamic$1(t.method, e),
						resolveStaticOrDynamic$1(t.url, e),
						!0
					),
						(r.timeout = resolveStaticOrDynamic$1(t.timeout, e)),
						(r.withCredentials = resolveStaticOrDynamic$1(
							t.withCredentials,
							e
						)),
						(r.responseType = resolveStaticOrDynamic$1(
							t.responseType,
							e
						)),
