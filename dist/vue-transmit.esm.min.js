...
var ParamNameStyle$1,
	...
	FirebaseDriver = (function() {
		...
		return (
			(e.prototype.cancelUpload = function(e) {
				var t = this.cancelTokens[e.id];
				return t
					? (t(),
					  delete this.cancelTokens[e.id],
					  this.context.emit(VTransmitEvents.Canceled, e),
					  [e])
					: [];
			}),
			(e.prototype.uploadFiles = function(e) {
				var t = this;
				console.log("firebase upload", { files: e });
				for (
					var i = [],
						r = function(r, s) {
							var a = e[r];
							i.push(
								new Promise(function(i) {
									var s = t.options.storageRef(a),
										n = t.options.metadata && t.options.metadata(a),
										o = s.put(e[r].nativeFile, n);
									(t.cancelTokens[a.id] = function() {
										return o.cancel();
									}),
										o.on(firebase.storage.TaskEvent.STATE_CHANGED, {
											complete: function() {
												delete t.cancelTokens[a.id], i();
											},
											next: function(e) {
												t.context.emit(
													VTransmitEvents.UploadProgress,
