	...
	methods: {
		...
		uploadFinished: function(files, response) {
			...
			for (var _a = 0, files_3 = files; _a < files_3.length; _a++) {
				...
				this.$emit.apply(
					this,
					[VTransmitEvents.Success, file, response].concat(args)
				);
			...
			if (this.uploadMultiple) {
				this.$emit.apply(
					this,
					[VTransmitEvents.SuccessMultiple, files, response].concat(args)
				);
...
var XHRDriver = /** @class */ (function() {
	function XHRDriver(context, options) {
		...
		var url = options.url,
			...
			paramName = _d === void 0 ? "file" : _d,
			_e = options.multipleParamNameStyle,
			multipleParamNameStyle = _e === void 0 ? ParamNameStyle$1.Empty : _e,
			_f = options.params,
			params = _f === void 0 ? Object.create(null) : _f,
			_g = options.headers,
			headers =
