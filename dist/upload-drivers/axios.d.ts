 ...
 */
export declare type AxiosDriverOptions<T = any> = {
	/**
...
export declare class AxiosDriver<T = any> implements DriverInterface {
	...
	constructor(context: VTransmitUploadContext, options: AxiosDriverOptions<T>);
